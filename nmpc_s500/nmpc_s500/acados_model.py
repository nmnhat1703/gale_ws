...
class QuadrotorEulerModel:
    def __init__(self, mass: float, Ixx: float = 0.029, Iyy: float = 0.029, Izz: float = 0.055):
        """Initialize quadrotor Euler dynamics model.

        Args:
            mass: Vehicle mass in kg
            Ixx, Iyy, Izz: Moment of inertia (kg·m²). Currently for documentation;
                           not used in the simplified gravity-mapped thrust model.
        """
